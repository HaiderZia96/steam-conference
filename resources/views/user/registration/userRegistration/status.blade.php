        ...
        <div class="card-body">
            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="mb-3">
                    ...
                    <select class="select2-options-registration-status-id form-control @error('registration-status') is-invalid @enderror" name="registration-status" disabled></select>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.select2-options-registration-status-id').select2({
                ...
                placeholder: 'Select Registration Status',
                ajax: {
                    // url: '{{route('user.get.user-registration-status')}}',
                    dataType: 'json',
                    delay: 250,
                    type: 'GET',
