...
{{-- <div class="col-5">
                ...
                <div class="mode-and-button d-flex align-items-center">
                    ...
                    @else
                        ...
                        <div class="d-flex">
                            <button class="header-btn custom-btn2 mt-3 mt-sm-0 mx-1">
                                <a href="{{Auth::user()->role_status == '1' ? url('admin/dashboard') : route('dashboard')}}">
                                    <h5 class="item-title">Dashboard</h5></a></button>
                ...
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample">
                    <div class="offcanvas-header">
                        <a class="navbar-brand" href="#">
                            <img src="{{asset('/front/coreui/assets/img/logo-sm-new.png')}}" alt="Header Logo"
                                 width="150px">
                        </a>
                                            ...
                                            <div class="col-7">
                                                <ul class="drop-down-menu">
                                                    ...
                                                    <li class="dropdown-item d-flex align-items-center">
                                                        ...
                                                        <a href="{{ route('front.paper-submission') }}"
                                                           class="item-content">
                                                            <h5 class="item-title">Paper Submission</h5>
                                                            {{-- <span class="item-sub">Sessions Overview</span> --}}
                                                        </a>
                            ...
                            <div class="mode-and-button d-flex align-items-center">
                                ...
                                @guest
                                    @if (Route::has('front.registration'))
                                        ...
                                        <button class="header-btn custom-btn2 mt-3 mt-sm-0 mx-1">
                                            <a href="{{route('front.registration')}}"><h5 class="item-title">
                                                    Register</h5>
                                                {{-- <i class="fa fa-arrow-right"></i> --}}
                                            </a>
                                        </button>
