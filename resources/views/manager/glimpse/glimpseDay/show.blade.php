            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" disabled class="form-control @error('day') is-invalid @enderror" name="day"
                               id="day" placeholder="Name" value="{{(isset($data) ? $data->day : old('day'))}}">
                        @error('day')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" disabled class="form-control @error('date') is-invalid @enderror" name="date"
                               id="date" placeholder="Date" value="{{(isset($data) ? $data->date : old('date'))}}">
                        @error('date')
                        <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
