        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                    @can('manager_steam-publication_publication-create')
                        <a href="{{(!empty($url) && isset($url)) ? $url : ''}}"
                           class="btn btn-sm btn-primary">{{(!empty($url_text) && isset($url_text)) ? $url_text : ''}}</a>
                    @endcan
                    @can('manager_steam-publication_publication-activity-log-trash')
                ...
                <div class="col-12 mb-4">
                    <fieldset class="reset-this redo-fieldset" style="margin-bottom: 10px">
                        ...
                        <div class="row gy-2 gx-3 align-items-center">
                            <div class="col-3">
                                <label class="mb-1" for="publication_type_id">Publication Type</label>
                                <select class="select2-options-publication-type-id form-control"
                                        name="publication_type_id" id="publication_type_id"
                                        autocomplete="publication_type_id">
                                </select>
                            </div>
                            <div class="col-3">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#indextable').DataTable({
                ...
                ajax: {
                    "type": "GET",
                    "url": "{{route('manager.get.publication')}}",
                    "data": function (d) {
                        d.publication_type_id = document.getElementById('publication_type_id').value;
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row, meta) {
                            ...
                            return '<div class="d-flex">' +
                                ...
                                '</a>' +
                                @endcan
                                    @can('manager_steam-publication_publication-download')
