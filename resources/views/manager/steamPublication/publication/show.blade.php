            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                @csrf
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" disabled class="form-control @error('author') is-invalid @enderror"
                               name="author" id="author" placeholder="Author"
                               value="{{(isset($data) ? $data->author : old('slug'))}}">
                        @error('author')
                        <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
                    <div class="col-md-6 mb-3">
                        ...
                        <select disabled class="form-control select2-options-publication-type-id  @error('publication_type') is-invalid @enderror" name="publication_type"></select>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select disabled class="form-control select2-options-department-id  @error('department') is-invalid @enderror" name="department"></select>
                        @error('department')
                        <strong class="text-danger">{{ $message }}</strong>
                        @enderror
                    </div>
