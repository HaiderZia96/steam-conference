        ...
        <div class="card-body">
            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" disabled class="form-control @error('password') is-invalid @enderror" name="password" id="password" placeholder="Password" value="">
                    @error('password')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    <label class="form-label" for="conference-year">Conference Year</label>
                    <select disabled class="select2-options-conference-year-id form-control @error('conference-year') is-invalid @enderror" name="conference-year"></select>
                    @error('conference-year')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
                <div class="mb-3">
                    <label class="form-label" for="payment">Payment Type</label>
                    <select disabled class="form-control select2-options-payment-id  @error('payment') is-invalid @enderror" name="payment"></select>
                    @error('payment')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <select disabled class="form-control select2-options-registration-id  @error('registration') is-invalid @enderror" name="registration"></select>
                    @error('registration')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <select disabled class="form-control select2-options-country-id  @error('country') is-invalid @enderror" name="country"></select>
                    @error('country')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <select disabled class="form-control select2-options-state-id  @error('state') is-invalid @enderror" name="state"></select>
                    @error('state')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <select disabled class="form-control select2-options-city-id  @error('city') is-invalid @enderror" name="city"></select>
                    @error('city')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
{{--                <div class="mb-3">--}}
{{--                    <label class="form-label" for="registration-status">Status Type</label>--}}
...
@push('footer-scripts')
    ...
    <script>
        $(document).ready(function() {
            //Get Conference Year
            let conference_year=[{
                id: "{{$data['conference_year_id']}}",
                text: "{{$data['conference_year_name']}}",
            }];
            $(".select2-options-conference-year-id").select2({
                data: conference_year,
                theme: "bootstrap5",
                placeholder: 'Select Conference Year',
            });
    ...
    let submission = [{
            ...
            $('.select2-options-registration-status-id').select2({
                ...
                placeholder: 'Select Registration Status',
                ajax: {
                    url: '{{route('manager.get.status-type-select')}}',
                    dataType: 'json',
                    delay: 250,
                    type: 'GET',
                    data: function (params){
