                ...
                <div class="col-12 mb-4">
                    <fieldset class="reset-this redo-fieldset" style="margin-bottom: 10px">
                        ...
                        <div class="row gy-2 gx-3 align-items-center">
                            <div class="col-3">
                                <label class="mb-1" for="faculty_id">Faculty</label>
                                <select class="select2-options-faculty-id form-control"
                                        name="faculty_id" id="faculty_id" autocomplete="faculty_id">
                                </select>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $('#indextable').DataTable({
                ...
                ajax: {
                    "type":"GET",
                    "url":"{{route('manager.get.department')}}",
                    "data": function (d) {
                        d.faculty_id = document.getElementById('faculty_id').value;
                    }
                },
                columns: [
                    { data: 'id'},
