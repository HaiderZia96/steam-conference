        ...
        <div class="card-body">
            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('fee') is-invalid @enderror" name="fee" id="fee" placeholder="Fee" value="{{old('fee')}}">
                    @error('fee')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('international-fee') is-invalid @enderror" name="international-fee" id="international-fee" placeholder="International Fee" value="{{old('international-fee')}}">
